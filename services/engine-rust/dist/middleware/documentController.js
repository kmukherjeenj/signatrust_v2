...
export const uploadDocument = async (req, res) => {
    ...
    try {
        ...
        const did = (_a = req.user) === null || _a === void 0 ? void 0 : _a.did;
        const cloudStorage = (_b = req.user) === null || _b === void 0 ? void 0 : _b.cloudStorage;
        if (!did) {
        ...
        const documentId = await documentService.storeDocumentReference(cloudStorage, documentHash, encryptedDocument, iv, 1 // Initial version
        );
...
export const getDocument = async (req, res) => {
    try {
        ...
        const decryptedDocument = await documentService.decryptDocument(docReference.encryptedDocument, Buffer.from(key, 'hex'), docReference.iv);
...
export const getDocuments = async (userDid) => {
    try {
