...
export const authMiddleware = async (req, res, next) => {
    ...
    try {
        ...
        const isValid = await zkProofService.verifyAuthProof(JSON.parse(zkProof), JSON.parse(publicSignals), challenge);
...
function extractDIDFromPublicSignals(publicSignals) {
