...
export const sendSignatureRequestEmail = async (email: string, signatureId: string): Promise<void> => {
  try {
...
export const notifyAllParties = async (signatureId: string): Promise<void> => {
  try {
